...
require_once plugin_dir_path(__FILE__) . 'includes/class-keycloak-auth-handler.php';
require_once plugin_dir_path(__FILE__) . 'includes/class-keycloak-shortcodes.php';
require_once plugin_dir_path(__FILE__) . 'includes/class-keycloak-admin-settings.php';
